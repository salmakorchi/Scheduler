              ...
              onCancel={this.modalCancelHandler}
               ...
               >
                ...
                <div className="input-group mb-3">
                  ...
                  <input type="text" className="form-control" placeholder="" aria-label="Title" aria-describedby="Title" ref={this.titleElRef} />
                </div>
                
                <div class="input-group mb-3">
                  <span className="input-group-text">Date</span>
                  <div class="col-10">
                    <input class="form-control" type="datetime-local"  id="example-date-input" ref={this.dateElRef}/>
                  </div>
                </div>
                ...
                <div className="input-group mb-3">
                  ...
                  <input type="number
                  " className="form-control" aria-label="Amount" ref={this.priceElRef}/>
                ...
                <div className="input-group">
                  ...
                  <textarea className="form-control" aria-label="Description" ref={this.descriptionElRef}></textarea>
                </div>
